...
@pytest.fixture
def new_string_card() -> str:
    return "Visa Gold 5999414228426353"


@pytest.fixture
def card_num_trace() -> bool:
...
@pytest.fixture
def data_various_state(state: str) -> list[dict[str, object]]:
    if state == "EXECUTED":
        dict_data = [
...
@pytest.fixture
def list_my_dict() -> list[dict[str, object]]:
    list_my_dict = [
...
@pytest.fixture
def list_my_dict_reverse_yes() -> list[dict[str, object]]:
    my_dict_reverse = [
        {"id": 41428829, "state": "EXECUTED", "date": "2020-05-02T18:35:29.512364"},
        {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},
        {"id": 615064591, "state": "CANCELED", "date": "2018-10-14T08:21:33.419441"},
...
@pytest.fixture
def list_my_dict_reverse_no() -> list[dict[str, object]]:
    my_dict_reverse = [
        {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"},
        {"id": 594226727, "state": "CANCELED", "date": "2018-09-12T21:27:25.241689"},
        {"id": 615064591, "state": "CANCELED", "date": "2018-10-14T08:21:33.419441"},
...
@pytest.fixture
def incorrect_type_dates_examination() -> list[dict[str, object]]:
