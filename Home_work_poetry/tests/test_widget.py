...
def test_mask_account_card_1(new_string: str, expected: str) -> None:
...
@pytest.mark.parametrize(
    "number_card, expected_card, number_account, expected_account",
    [("Visa Gold 5999414228426553", "Visa Gold 5999 41 ** **** 6553", "Счет 73654108430135879456", "Счет **9456")],
)
def test_mask_account_card(
    ...
    error_numb: str = "Visa Gold" "59994142284226553",
    error_expected: str = "Ошибка данных",
) -> None:
...
def test_get_date_is_wrong_date(input_data: str) -> None:
...
@pytest.mark.parametrize(
    "input_data_type", ["31st of February, 2023", "2023-02", "31.02.23", "31.02.2023", [], "26:18.671407", "Hello"]
)
def test_get_date_is_wrong_type(input_data_type: str) -> None:
    """Проверка, что функция корректно обрабатывает входные строки, где отсутствует дата"""
