...
def test_filter_by_state(test_dict_for_search: list[dict[str, object]], expected: list[dict[str, object]]) -> None:
    """Тестирование фильтрации списка словарей по заданному статусу state"""
    assert filter_by_state(test_dict_for_search) == expected


@pytest.mark.parametrize(
    "test_dict_for_search",
    [
        (
            [
...
def test_filter_by_state_empty_executed(test_dict_for_search: list[dict[str, object]]) -> None:
    """Проверка работы функции при отсутствии словарей с указанным статусом state в списке"""
    assert filter_by_state(test_dict_for_search) == []


@pytest.mark.parametrize(
    "test_dict_for_search, state",
    [
        (
            [
...
def test_filter_by_state_various_state(
    test_dict_for_search: list[dict[str, object]], state: str, data_various_state: list[dict[str, object]]
) -> None:
...
def test_sort_by_date_true(
    list_my_dict: list[dict[str, object]], list_my_dict_reverse_yes: list[dict[str, object]], revers: bool = True
) -> None:
...
def test_sort_by_date_false(
    list_my_dict: list[dict[str, object]], list_my_dict_reverse_no: list[dict[str, object]], revers: bool = False
) -> None:
...
def test_list_my_dict_same_dates(list_my_dict: list, list_my_dict_reverse_no: list, revers: bool = False) -> None:
    """Проверка корректности сортировки при одинаковых датах."""
    assert sort_by_date(list_my_dict, sort_reverse=revers) == list_my_dict_reverse_no


def test_incorrect_type_dates_examination(
    incorrect_type_dates_examination: list, expected: str = "Неверный формат даты"
) -> None:
